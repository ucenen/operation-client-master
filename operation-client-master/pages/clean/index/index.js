...
Page({
  ...
  openpage(e) {
    ...
    app.sdk.look_equipment(obj, success => {
     wx.hideLoading()
		 if(success.data.return_code == 'success'){
       wx.setStorageSync('clean_eqNumber', success.data.return_msg.eqNumber)
       wx.setStorageSync('clean_equipment', success.data)
		   wx.navigateTo({
