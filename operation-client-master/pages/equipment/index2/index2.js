// pages/equipment/index2/index2.js
var app = getApp();
Page({
  ...
  openpage(e) {
    ...
    app.sdk.look_temperature_config(obj, success => {
      wx.hideLoading()
      if (success.data.return_code == 'success') {
        wx.setStorageSync('temp_eqNumber', that.data.eqNumber);
        wx.setStorageSync('temp_equipment', success.data.return_msg)
        wx.navigateTo({
